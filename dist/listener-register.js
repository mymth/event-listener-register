(function (global, factory) {
  ...
  (global = global || self, factory(global.listenerRegsiter = {}));
   ...
   */
  function addListener(target, type, listener, options = undefined, name = undefined) {
   ...
   * suffix
   */
  function removeListener(target, type = undefined, listener = undefined, options = undefined) {
    let listeners = listenerRegistries.get(target);
    if (!listeners) {
      return;
    }
